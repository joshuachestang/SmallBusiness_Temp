...
* [Spree Commerce]{http://spreecommerce.com/) => This is an RoR shopping cart with this I install the
		[Spree Gatway](https://github.com/spree/spree_gateway) for a listing of all gateways.
